...
<header class="header" id="header">
    ...
    <div class="uk-container header__container">
        ...
        <a href="{{route("landing-page")}}" class="header__logo"><img src="{{asset('assets/front/images/weelfeed-brand-logo.svg')}}" class="header__logo-img" alt="Weelfeed Brand Logo" height="39" width="99"></a>
                ...
                <div class="uk-width-auto help__col">
                    <div class="help__media">
                        ...
                        <div class="help__call">
                            <a href="tel:+39 3492442269" class="help__call-num">+39 349 244 2269</a>
                        </div>
                        ...
                        <div class="uk-width-1-2 footer-contact__col">
                            <div class="footer-contact__item">
                                ...
                                <div class="footer-contact__data">
                                    ...
                                    <a href="tel:+39 3492442269" class="footer-contact__href">+39 349 244 2269</a>
                                </div>
                            </div>
                        </div>
                        <div class="uk-width-1-2 footer-contact__col">
