                ...
                var dt_user = dt_user_table.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        render: function render(data, type, full, meta) {
                            return '<div class="d-inline-block text-nowrap">' + "<a href=\"/product/" + full['product_id'] + "/edit?customerGroup="+customerGroup+"\" class=\"btn btn-sm btn-icon\" data-id=\"".concat(full['product_id'], "\"><i class=\"ti ti-edit\"></i></a>") + "<button class=\"btn btn-sm btn-icon delete-record\" data-id=\"".concat(full['product_id'], "\"><i class=\"ti ti-trash delete-record-button\"></i></button>") + '<div class="dropdown-menu dropdown-menu-end m-0">' + '<a href="' + userView + '" class="dropdown-item">View</a>' + '<a href="javascript:;" class="dropdown-item">Suspend</a>' + '</div>' + '</div>';
                        }
                    }, {
                        // product_name
                        targets: 0,
