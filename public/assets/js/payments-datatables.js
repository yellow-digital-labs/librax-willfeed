    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ...
            columnDefs: [{
                ...
                responsivePriority: 4,
                render: function render(data, type, full, meta) {
                    var $id = full['id'] ? full['id'] : '';
                    return '<span class="user-id">' + $id + '</span>';
                }
            }, {
                ...
                responsivePriority: 4,
                render: function render(data, type, full, meta) {
                    var $transaction_datetime = full['transaction_datetime'] ? full['transaction_datetime'] : '';
                ...
                responsivePriority: 4,
                render: function render(data, type, full, meta) {
                    var $subscription_amount = full['subscription_amount'] ? full['subscription_amount'] : '';
                    return '<span class="user-subscription_amount">' + $subscription_amount + '</span>';
                }
            }, {
                // card
                targets: 4,
                ...
                responsivePriority: 4,
                render: function render(data, type, full, meta) {
                    var $card = full['card'] ? full['card'] : '';
                    return '<span class="user-card">' + $card + '</span>';
                }
            }, {
                // transaction_no
                targets: 5,
                ...
                responsivePriority: 4,
                render: function render(data, type, full, meta) {
                    var $transaction_no = full['transaction_no'] ? full['transaction_no'] : '';
                    return '<span class="user-transaction_no">' + $transaction_no + '</span>';
                }
            }, {
                // Payment Status
                targets: 6,
