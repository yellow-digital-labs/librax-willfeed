      ...
      columnDefs: [
        ...
        },
        {
        ...
        },
         {
          ...
          responsivePriority: 4,
          render: function render(data, type, full, meta) {
            var $ip_address = full["ip_address"] ? full["ip_address"] : "";
            return '<span class="user-user_name">' + $ip_address + "</span>";
          },
        },
        {
          // consents
          ...
          render: function render(data, type, full, meta) {
           ...
           if ($consents.includes("essentials")) {
                $consents = 'Essenziali';
            } else if ($consents === "Accepted All") {
                $consents = 'Accettato tutti';
            } else if ($consents === "Rejected All") {
                $consents = 'Rifiutati tutti';
            }
