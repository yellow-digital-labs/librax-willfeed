                ...
                var dt_user = dt_user_table.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        render: function render(data, type, full, meta) {
                            return '<div class="d-inline-block text-nowrap">' + "<a href=\"/email-template-management/" + full['id'] + "/edit\" class=\"btn btn-sm btn-icon\" data-id=\"".concat(full['id'], "\"><i class=\"ti ti-edit\"></i></a>") + '<div class="dropdown-menu dropdown-menu-end m-0">' + '<a href="' + userView + '" class="dropdown-item">View</a>' + '<a href="javascript:;" class="dropdown-item">Suspend</a>' + '</div>' + '</div>';
                        }
                    }, {
                        // name
                        targets: 0,
                        ...
                        render: function render(data, type, full, meta) {
                            var $name = full['mailable'] ? full['mailable'] : '';
                            $name = $name.replace('App\\Mail\\', "");
